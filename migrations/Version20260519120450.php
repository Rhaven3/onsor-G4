 ...
 */
final class Version20260519120450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trip (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, limit_registration_date DATETIME DEFAULT NULL, description LONGTEXT NOT NULL, state VARCHAR(255) NOT NULL, max_registration INT NOT NULL, user_id INT DEFAULT NULL, organisator_id INT NOT NULL, address_id INT NOT NULL, site_id INT NOT NULL, INDEX IDX_7656F53BA76ED395 (user_id), INDEX IDX_7656F53BFFDD4EC8 (organisator_id), INDEX IDX_7656F53BF5B7AF75 (address_id), INDEX IDX_7656F53BF6BD1646 (site_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, site_id INT NOT NULL, INDEX IDX_8D93D649F6BD1646 (site_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
